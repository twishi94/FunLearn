...
public class valid_letter_p : MonoBehaviour, Vuforia.ITrackableEventHandler
{
    ...
    private int flip = 0;
    private GameObject P_GREEN = null;
    private GameObject d_red = null;
    int time = 0;
    ...
    void Start()
    {
        P_GREEN = gameObject.transform.Find("p_green").gameObject;
        P_GREEN.SetActive(false);
        d_red = gameObject.transform.Find("d_red").gameObject;
