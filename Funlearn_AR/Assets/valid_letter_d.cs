...
public class valid_letter_d : MonoBehaviour, Vuforia.ITrackableEventHandler
{
    ...
    private int flip = 0;
    private GameObject P_RED = null;
    private GameObject d_green = null;
    int time = 0;
    ...
    void Start()
    {
        P_RED = gameObject.transform.Find("p_red").gameObject;
        P_RED.SetActive(false);
        d_green = gameObject.transform.Find("d_green").gameObject;
        d_green.SetActive(false);
...

    {
        ...
        foreach (TrackableBehaviour tb in activeTrackables)
        {
            ...
            if (tb.TrackableName == "d_playcard")
                count = 1;
        }
