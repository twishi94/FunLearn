...
public class DragAndDropCell : MonoBehaviour, IDropHandler
{
    ...
    public AudioSource wrongAudio, congo;
    ...
    public void OnDrop(PointerEventData data)
    {
        ...
        if (DragAndDropItem.icon != null)
        {
            ...
            if (DragAndDropItem.icon.activeSelf == true)                    // If icon inactive do not need to drop item into cell
            {
                ...
                if ((item != null) && (sourceCell != this) && (item.name == itemName))
                {
                    congo.Play();
                                    ...
                                    if (desc.permission == true)            // If drop permitted by application
                                    {
										if (myDadItem != null)            // If destination cell has item
                                        {
                                            ...
                                            if (descAutoswap.permission == true)            // If drop permitted by application
                                            {
                                                ...
                                                Debug.Log("Incorrect");// Swap items between cells
                                            }
                                            else
                                            {
                                                ...
                                                Debug.Log("Incorrect");         // Delete old item and place dropped item into this cell
                                            }
                                        }
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                Debug.Log("Incorrect");
											                ...
											                // Place dropped item into this empty cell
                                        }
                                    }
                                    break;
                ...
                } else if((item != null) && (sourceCell != this) && (item.name != itemName))
                {
                    wrongAudio.Play();
                }
            }
